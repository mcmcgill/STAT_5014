...
boxplot(func(obsdata)$"dev1 mean",func(obsdata)$"dev2 mean",names=c("dev1","dev2"),
      main="Boxplot of Means by Dev",col="purple")
...
library(vioplot)
setwd("C:/Users/mmcgi/OneDrive/Documents/homework/STAT_5014_homework/03_good_programming_R_functions")
obsdata<-readRDS("./03_good_programming_R_functions/HW3_data.rds")
func<-function(data){
            data1<-data[data$Observer=='1',]
        obs1<-c(1,apply(data1[2:3],2,mean),apply(data1[2:3],2,sd),cor(data1[2],data1[3]))
            data2<-data[data$Observer=='2',]
